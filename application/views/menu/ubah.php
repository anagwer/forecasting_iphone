				...
				<div class="row">
					<div class="col-md-12">
						<div class="card shadow">
							<div class="card-body">
								<form action="<?= base_url('menu/proses_ubah/' . $menu->id) ?>" id="form-tambah" method="POST" enctype="multipart/form-data">
									<div class="form-row">
									...
									<div class="form-row">
										<div class="form-group col-md-12">
											...
											<textarea name="deskripsi" class="form-control" placeholder="Masukkan Deskripsi" rows="3" required><?= $menu->deskripsi ?></textarea>
										</div>
									</div>
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="harga"><strong>Harga</strong></label>
											<input type="number" name="harga" placeholder="Masukkan Harga Jual" autocomplete="off"  class="form-control" required value="<?= $menu->harga ?>">
										</div>
										<div class="form-group col-md-6">
											...
											<select name="is_aktif" class="form-control" required>
												...
												<option value="0" <?= $menu->is_aktif == 0 ? 'selected' : '' ?>>Tidak Aktif</option>
											</select>
										</div>
									</div>
									<div class="form-row">
										<div class="form-group col-md-12">
											<label for="foto"><strong>Foto Menu (Abaikan jika tidak diubah)</strong></label>
